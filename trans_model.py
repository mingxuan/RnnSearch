...
class Decoder(GRU):
    ...
    def init_state(self, context):
        return T.tanh(theano.dot(context.mean(0), self.W_c_init))
...
class Translate(object):
    ...
    def __init__(self,
        ...
        self.logistic = LogisticRegression(self.decoder.n_out, trg_vocab_size, prefix='logistic',  drop_rate=kwargs['dropout'])
